...
function install_theme_esthemes() {
    ...
    mkdir -p "$configdir/all/emulationstation/themes"
    gitPullOrClone "$configdir/all/emulationstation/themes/$theme" "https://github.com/$repo/es-theme-$theme.git" "$default_branch"
}
