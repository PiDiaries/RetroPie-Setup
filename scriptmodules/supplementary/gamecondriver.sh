...
function dual_snes_gamecondriver() {
    ...
    if dialog --yesno "Would you like to update button mappings in /home/RetroPie/configs/$user/all/retroarch/retroarch.cfg for 2 SNES controllers?" 22 76 >/dev/tty; then
        if [[ "$GPIOREV" == 1 ]]; then
