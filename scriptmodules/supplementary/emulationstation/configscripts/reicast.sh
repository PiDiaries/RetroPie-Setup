...
function onstart_reicast_joystick() {
    ...
    case "$DEVICE_NAME" in
        "Xbox 360 Controller (xpad driver)")
            file="/home/RetroPie/configs/$USER/dreamcast/mappings/controller_xpad.cfg"
            ;;
        "Xbox 360 Controller (xboxdrv userspace driver)")
            file="/home/RetroPie/configs/$USER/dreamcast/mappings/controller_xboxdrv.cfg"
            ;;
        *)
            file="/home/RetroPie/configs/$USER/dreamcast/mappings/evdev_${DEVICE_NAME//[:><?\"]/-}.cfg"
            ;;
    esac

    # create mapping dir if necessary.
    mkdir -p "/home/RetroPie/configs/$USER/dreamcast/mappings"
