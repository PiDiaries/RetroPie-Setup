...
function _add_system_mehstation() {
    ...
    NAME="$fullname" COMMAND="$command" DIR="$path" EXTS="$extensions" "/home/$user/RetroPie/opt/supplementary/mehstation/bin/mehtadata" -db="$db" -new-platform
}
...
function _del_system_mehstation() {
    ...
    PLATFORM_NAME="$fullname" "/home/$user/RetroPie/opt/supplementary/mehstation/bin/mehtadata" -db="$db" -del-platform
}
...
function _add_rom_mehstation() {
    ...
    NAME="$4" FILEPATH="$path" PLATFORM_NAME="$system_fullname" DESCRIPTION="$desc" "/home/$user/RetroPie/opt/supplementary/mehstation/bin/mehtadata" -db="$db" -new-exec

    RESOURCE="$image" FILEPATH="$path" PLATFORM_NAME="$system_fullname" TYPE="cover" "/home/$user/RetroPie/opt/supplementary/mehstation/bin/mehtadata" -db="$db" -new-res
}
