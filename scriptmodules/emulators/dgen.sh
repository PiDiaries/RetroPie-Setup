...
function configure_dgen() {
    local system
    for system in genesis megadrive megadrive-extras megadrive-japan megadrive-translations segacd segacd-extras segacd-japan segacd-translations segacd-usa sega32x sega32x-extras sega32x-japan sega32x-usa ; do
        mkRomDir "$system"
